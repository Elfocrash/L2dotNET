    ...
    public class PlayerRepository : IPlayerRepository
    {
        ...
        public void CreatePlayer(PlayerModel player)
        {
            this.db.Execute(@"insert into characters (account_name, obj_Id, char_name, Level, MaxHp, CurHp, MaxCp, CurCp,MaxMp,CurMp,
               Face,HairStyle,HairColor,Sex,Heading,X,Y,Z,Exp,ExpBeforeDeath,Sp,Karma,PvpKills,PkKills,ClanId,base_class, DeleteTime,CanCraft,Title,
               ...
               @Face,@HairStyle,@HairColor,@Sex,@Heading,@X,@Y,@Z,@Exp,@ExpBeforeDeath,@Sp,@Karma,@PvpKills,@PkKills,@ClanId,@base_class, @DeleteTime,@CanCraft,@Title,
                ...
                Karma = player.Karma, PvpKills = player.PvpKills, PkKills = player.PkKills, ClanId = player.ClanId, base_class = player.BaseClass, DeleteTime = player.DeleteTime,

...
namespace L2dotNET.GameService.Model.Npcs.Ai
{
    ...
    {
        private readonly int[][] _data = new int[21][];

        public BroadcastingTower()
        {
            Id = 31031;
            _data[00] = new[] { 612, 620, 500, -18347, 114000, -2360 };
            _data[01] = new[] { 612, 621, 500, -18347, 113255, -2447 };
            _data[02] = new[] { 613, 622, 500, 22321, 155785, -2604 };
            _data[03] = new[] { 613, 623, 500, 22321, 156492, -2627 };
            _data[04] = new[] { 614, 624, 500, 112000, 144864, -2445 };
            _data[05] = new[] { 614, 625, 500, 112657, 144864, -2525 };
            _data[06] = new[] { 615, 626, 500, 116260, 244600, -775 };
            _data[07] = new[] { 615, 627, 500, 116260, 245264, -721 };
            _data[08] = new[] { 616, 628, 500, 78100, 36950, -2242 };
            _data[09] = new[] { 616, 629, 500, 78744, 36950, -2244 };
        ...
        public override void OnShowChat(L2Player player, L2Npc npc)
        {
            ...
            string text = string.Join(string.Empty, ar.Select(val => $"<a action=\"bypass -h menu_select?ask=-2&reply={val}\">&${val};</a><br1>").ToArray());

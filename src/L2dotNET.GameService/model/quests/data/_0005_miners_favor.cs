...
namespace L2dotNET.GameService.Model.Quests.Data
{
    class _0005_miners_favor : QuestOrigin
    {
        ...
        public _0005_miners_favor()
        {
            ...
            talkNpcs = new[] { startNpc, trader_chali, trader_garita, warehouse_chief_reed, blacksmith_bronp };
            actItems = new[] { bolters_list, mining_boots, miners_pick, boomboom_powder, redstone_beer, bolters_smelly_socks };
        }
